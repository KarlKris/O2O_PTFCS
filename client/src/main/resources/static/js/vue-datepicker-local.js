    	 ...
    	 module.exports = t() : 
    	 	"function" == typeof define && define.amd ? 
    	 		define([], t) : 
    	 			...
    	 			exports["vue-datepicker-local"] = t() : e["vue-datepicker-local"] = t()
...
function() {
    return function(e) {
        ...
        function n(e, t, s, n, o, a, r, i) {
            ...
            var c = typeof e.
        default;
            "object" !== c && "function" !== c || (e = e.
        default);
            var u = "function" == typeof e ? e.options: e;
            t && (u.render = t, u.staticRenderFns = s, u._compiled = !0),
            n && (u.functional = !0),
            a && (u._scopeId = a);
            var l;
            if (r ? (l = function(e) {
        ...
        var i = {
            ...
            methods: {
                ...
                status: function(e, t, s, n, o, a, r) {
                    ...
                    d = {},
                    p = !1;
                    return p = "YYYY" === r ? e === i.year: "YYYYMM" === r ? t === i.month: h(i.value, r) === h(u, r),
                    d[i.pre + "-date"] = !0,
                    d[i.pre + "-date-disabled"] = i.right && l < i.start || i.$parent.disabledDate(u, r),
                    d[i.pre + "-date-on"] = i.left && l > i.start || i.right && l < i.end,
                    d[i.pre + "-date-selected"] = p,
                    d
                },
                nm: function() {
                ...
                ok: function(e) {
                    ...
                    t.left && parseInt(r.getTime() / 1e3) > t.end && (this.$parent.dates[1] = r),
                    t.$emit("input", r),
                    t.$parent.ok("h" === e)
                }
            },
        ...
        c = function() {
            ...
            [e._v(e._s(e.local.hourTip))]), e._l(24,
            function(t, n) {
                return s("a", {
                    key: n,
            ...
            [e._v(e._s(e.local.minuteTip))]), e._l(60,
            function(t, n) {
                return s("a", {
                    key: n,
            ...
            [e._v(e._s(e.local.secondTip))]), e._l(60,
            function(t, n) {
                return s("a", {
                    key: n,
            ...
            [s("a", {
                ...
                on: {
                    click: function(t) {
                        e.showHours = !e.showHours,
                        e.showMinutes = e.showSeconds = !1
                    }
                }
            },
            [e._v(e._s(e._f("dd")(e.hour)))]), s("span", [e._v(":")]), s("a", {
                ...
                on: {
                    click: function(t) {
                        e.showMinutes = !e.showMinutes,
                        e.showHours = e.showSeconds = !1
                    }
                }
            },
            [e._v(e._s(e._f("dd")(e.minute)))]), s("span", [e._v(":")]), s("a", {
                ...
                on: {
                    click: function(t) {
                        e.showSeconds = !e.showSeconds,
                        e.showHours = e.showMinutes = !1
                    }
                }
            },
        ...
        p = {
            ...
            methods: {
                ...
                ok: function(e) {
                    var t = this;
                    t.$emit("input", t.get()),
                    !e && !t.showButtons && setTimeout(function() {
                        t.show = t.range
                    })
                },
                tf: function(e, t) {
                    ...
                    return (t || this.format).replace(/Y+|M+|D+|H+|h+|m+|s+|S+/g,
                    function(e) {
                        return h[e]
                    })
                },
        ...
        f = function() {
            ...
            return s("div", {
                ...
                class: {
                    "datepicker-range": e.range,
                    datepicker__clearable: e.clearable && e.text && !e.disabled
                }
            },
